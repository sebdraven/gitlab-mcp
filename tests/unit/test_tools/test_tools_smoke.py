...
class TestServerToolRegistration:
    ...
    def test_register_all_tools_adds_67_tools(self, server):
        """Test that register_all_tools registers all 139 tools."""
        # Initially no tools
        ...
        # Should have 139 tools registered
        assert len(server._tools) == 139
...
class TestToolCounts:
    ...
    def test_total_tool_count(self):
        """Test that __all__ has 143 total exports."""
        # Total MCP tools: 139
        ...
        # Variables (CI/CD project): 5 (list, get, create, update, delete)
        ...
        # Search: 3 (global, in_group, in_project)
        # Webhooks: 11 (6 project + 5 group)
        # MR discussions: 7 (list, get, create, add_note, resolve, update_note, delete_note)
        # Meta-tools (slim mode): 4 (discover_tools, get_tool_schema, execute_tool, TOOL_CATEGORIES)
        # Total: 143 tools (139 regular + 4 meta-tools)
        assert len(tools.__all__) == 143
